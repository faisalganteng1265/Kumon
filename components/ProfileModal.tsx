      ...
      <div className="bg-[#fef9ed] rounded-3xl w-full max-w-4xl relative overflow-hidden max-h-[90vh] overflow-y-auto" style={{ boxShadow: '8px 8px 0px rgba(0, 0, 0, 1)' }}>
        ...
        <div className="relative z-10 p-10">
          ...
          <div className="flex items-center gap-3 mb-8">
            ...
            <h2 className="text-3xl font-bold text-gray-900" style={{ fontFamily: "'Fredoka', sans-serif" }}>My Profile</h2>
          </div>

          {/* Tab Switcher */}
          <div className="flex gap-2 mb-8 p-1 bg-white rounded-xl" style={{ boxShadow: '4px 4px 0px rgba(0, 0, 0, 1)', fontFamily: "'Fredoka', sans-serif" }}>
            <button
              onClick={() => {
          ...
          {activeTab === 'account' && (
            <form onSubmit={handleUpdateAccount} className="space-y-6">
              ...
              <div className="flex flex-col items-center mb-8">
                <label className="block text-sm font-semibold text-gray-700 mb-4" style={{ fontFamily: "'Fredoka', sans-serif" }}>Profile Picture</label>
                ...
                <p className="text-sm text-gray-600 text-center" style={{ fontFamily: "'Fredoka', sans-serif" }}>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <label className="block text-sm font-semibold text-gray-700 mb-3" style={{ fontFamily: "'Fredoka', sans-serif" }}>Username</label>
                  <div className="relative">
                ...
                <div>
                  <label className="block text-sm font-semibold text-gray-700 mb-3" style={{ fontFamily: "'Fredoka', sans-serif" }}>Email</label>
                  <div className="relative">
                    <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                      <svg className="h-5 w-5 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <p className="text-xs text-gray-500 mt-2" style={{ fontFamily: "'Fredoka', sans-serif" }}>
              ...
              <div className="border-t border-gray-300 pt-6">
                <h3 className="text-gray-900 font-bold text-lg mb-4 flex items-center gap-2" style={{ fontFamily: "'Fredoka', sans-serif" }}>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <label className="block text-sm font-semibold text-gray-700 mb-3" style={{ fontFamily: "'Fredoka', sans-serif" }}>
                      New Password
                    </label>
                    <div className="relative">
                      <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
              ...
              {error && (
                <div className="bg-red-500/10 border border-red-500/50 rounded-xl p-4 flex items-start gap-3">
                  ...
                  <p className="text-red-400 text-sm" style={{ fontFamily: "'Fredoka', sans-serif" }}>{error}</p>
                </div>
              )}
              ...
              {success && (
                <div className="bg-green-500/10 border border-green-500/50 rounded-xl p-4 flex items-start gap-3">
                  ...
                  <p className="text-green-400 text-sm" style={{ fontFamily: "'Fredoka', sans-serif" }}>{success}</p>
                </div>
              )}
              ...
              <button
                ...
                style={{ boxShadow: '5px 5px 0px rgba(0, 0, 0, 1)', fontFamily: "'Fredoka', sans-serif" }}
              >
          ...
          {activeTab === 'profile' && (
            <form onSubmit={handleUpdateProfile} className="space-y-6">
              <div>
                <label className="block text-sm font-semibold text-gray-700 mb-3 flex items-center gap-2" style={{ fontFamily: "'Fredoka', sans-serif" }}>
              ...
              <div>
                ...
                <p className="text-sm text-gray-600 mt-2 flex items-center gap-1" style={{ fontFamily: "'Fredoka', sans-serif" }}>
